...
def evaluate(data_source, out_file, batch_size=10, on_train=False):
    ...
    for i in range(0, data_source.size(0) - args.bptt, args.bptt):
        ...
        with torch.no_grad():
            ...
            data_adv_autoenc = autoenc_greedy(best_beam_data, batch_size)
...
print(val_lm_loss)
print(val_correct_msg)
print(val_correct_bits_msg)
print(val_meteor)
print(val_l2_sbert)
print(val_correct_fake)
print(val_correct_real)
print(val_Fscore)
print(val_pvalue)
print(val_pvalue_inst)
