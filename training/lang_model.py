...
class RNNModel(nn.Module):
    ...
    def init_lstm_weights(self, model):
        with torch.no_grad():
            self.encoder.weight.data = copy.deepcopy(model.encoder.weight.data)
            self.decoder.bias.data = copy.deepcopy(model.decoder.bias.data)
